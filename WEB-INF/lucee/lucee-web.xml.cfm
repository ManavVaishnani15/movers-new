<?xml version="1.0" encoding="UTF-8" standalone="no"?><cfLuceeConfiguration hspw="cadd7a26fff1ed8842b6c26b0caf4e6bbc6e80f0e01fbacb9790386a27fa6290" salt="4D8D74DF-AE7A-4FAC-8142E4027B2605C2" version="5.2">
...
-->
    ...
    arguments:
	 ...
	 -->
	<setting allow-compression="false" buffering-output="false" cfml-writer="regular" content-length="" suppress-content="false"/>
...
<!--	or ask your database distributor 																-->
	...
	<data-sources>
	<data-source allow="511" always-set-timeout="true" blob="false" class="com.mysql.cj.jdbc.Driver" clob="false" connectionLimit="100" connectionTimeout="1" custom="useUnicode=true&amp;characterEncoding=UTF-8&amp;serverTimezone=America%2FChicago&amp;maxReconnects=3&amp;useLegacyDatetimeCode=true" database="onestep" dbdriver="MySQL" dsn="jdbc:mysql://{host}:{port}/{database}" host="localhost" id="mysql" metaCacheTimeout="60000" name="aaalh3x_onestep" param-delimiter="&amp;" param-leading-delimiter="?" param-separator="=" password="encrypted:117b8f9543634021ff8300b9048b53be7d94248be2ce5d06ca5c33a1148c777d525aa108a5da94a9549e7fa56803097d" port="3306" storage="false" username="onestep" validate="false"/></data-sources>
	...
	<mail>
	<server idle="20000" life="60000" password="encrypted:62343784e5b1f9aeab8a4f1f88aadb8567ae9757f412c9d01ca0763b55e10f4c" port="26" reuse-connection="true" smtp="localhost" ssl="false" tls="false" username="support@affordableusamovers.com"/></mail>
...
<datasource/><rest/><gateways/><orm/><search/><charset resource-charset="UTF-8" template-charset="UTF-8" web-charset="UTF-8"/></cfLuceeConfiguration>