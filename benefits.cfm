...
<html>
	<head>
		<title>Top12MovingBiz - Partner Benefits</title>
							...
							<tr>
								...
								<tr>
									...
									<table border="0" cellspacing="0" cellpadding="0" width="100%">
										<tr>
											<td bgcolor="#332846" height="47"><div align="center"><a href="index.cfm?a=a<cfif parameterexists(affid) is 'yes'><cfoutput>&affid=#affid#</cfoutput></cfif>"><IMG border=0 alt="Home Page" src="images/home-off.jpg" width =210 height=47 ><A href="signup.cfm?a=a<cfif parameterexists(affid) is 'yes'><cfoutput>&affid=#affid#</cfoutput></cfif>"><IMG border=0 alt="Partner Signup" src="images/partner-signup-off.jpg" width =239 height=47 ></A><a href="about-us.cfm?a=a<cfif parameterexists(affid) is 'yes'><cfoutput>&affid=#affid#</cfoutput></cfif>"><IMG border=0 alt="About Top12MovingBiz" src="images/about-us-off.jpg" width =181 height=47 ></a><IMG border=0 alt="Partner Benefits" src="images/benefits.jpg" width =333 height=47 ></DIV></TD></TR></TABLE>
											<table border="0" cellspacing="0" cellpadding="5" width="1000">
												<tr>
													<td width="1000">
														<br>
														<font face="arial" size="4" color="182430"><b>Partner Benefits</b></font><br>
														<br>
													</TD></TR></TABLE>
													<table border="0" cellspacing="0" cellpadding="0" width="1000">
