...
<cfquery name="carrierprintQueue" datasource="aaalh3x_onestep">
	select id
...
<cfquery name="carrierfollowupprintQueue" datasource="aaalh3x_onestep">
	select id
	from carrier_printQUeue
	where printed=0
	and (memberId=#verify.id# or memberId is null)
...
<cfquery name="currentcarriercount" datasource="aaalh3x_onestep">
select * from carrier_LETTER_SENDS
where send_type=999 and active=1 and user_hook=#verify.id#
</cfquery>
<cfquery name="carrierfollowupcount" datasource="aaalh3x_onestep">
select * from carrier_LETTER_SENDS
where send_type=998 and active=1 and user_hook=#verify.id#
and coalesce(followup_date,'#datenow#') = <cfqueryparam cfsqltype="cf_sql_date" value="#datenow#">
</cfquery>
...
<table border="0" cellspacing="0" cellpadding="5" width="100%">
	<tr>
		<td width="50%">
		<strong style="font-family:arial">CLIENT SECTION</strong><br><br>
		...
		<table>
			<tr style="font-family:Arial; font-size:15px;">
				...
				<td><cfoutput><input type="date" name="QueueDate" value="#dateFormat(now(), "yyyy-mm-dd")#"></cfoutput></td>
...
<font face="arial" size="3">
	...
	<b><A href="clearPrintQueue.cfm?un=#un#&pw=#pw#">Clear Letter Queue</A></b>
<Br><Br>
	...
	<b><A href="clearPrintQueue.cfm?un=#un#&pw=#pw#&type=followUp">Clear Follow Up Letter Queue</A></b><br>
<Br><Br>
	...
	<b><A href="clearPrintQueue.cfm?un=#un#&pw=#pw#&type=hanger">Clear Hanger Letter Queue</A></b><br>
</font>
</cfoutput>
<Br><Br>
