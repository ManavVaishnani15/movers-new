...
<cfquery name="currentcount" datasource="aaalh3x_onestep">
	...
	where (send_type='#queueCode#' <cfif queueCode eq '999'>or send_type=101 or send_type=102</cfif>) and active=1 and user_hook=#verify.id#
...
<tr><td><img src="labelbox.jpg" width="200" height="81" border="0" alt=""></td>
<td><img src="labelbox.jpg" width="200" height="81" border="0" alt=""></td><cfset COLUMNNBR = 3></cfif>
<cfloop query="currentcount" startrow="1" endrow="#THENBR#"><cfquery name="g" datasource="aaalh3x_onestep">select * from realtor_records
where id=#currentcount.cust_hook#</cfquery>

<cfoutput><cfif #COLUMNNBR# is 1 and #ROWNBR# LT 11><tr><td style="font-size:12px;">

<cfif #g.repfirstname# is not ''>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>ATTN #g.repfirstname# #g.replastname#</b><cfelse></cfif><br/>
<cfif #g.CompanyName# is not ''>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#g.CompanyName#<br/></cfif>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#g.agencyaddress#<br />
<cfif #g.agencyaddress2# is not ''>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#g.agencyaddress2#<br/></cfif>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#g.agencycity# #g.agencystate# #g.agencyzip#<br/><br/>
</td>
