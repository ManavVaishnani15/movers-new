...
<cfif parameterexists(clear_queue) is 'yes'><!--- clearing the mail queue --->
	<cfquery name="currentcount" datasource="aaalh3x_onestep">
		...
		where (send_type=999 or send_type=101 or send_type=102) and active=1 and user_hook=#verify.id#
	</cfquery>
...
<strong style="font-family:arial">REALTOR SECTION</strong><br><br>
<a href="add_Realtor_NEW.cfm?un=#un#&pw=#pw#"><font face="arial" size="3" color="blue">Enter New Realtor Record</font></a>
<br><br>
<a href="Realtor_searchPage.cfm?un=#un#&pw=#pw#"><font face="arial" size="3" color="blue">Search Realtors</font></a>
<br><br>
...
<tr>
<Td colspan="3" bgcolor="silver"><div align="center"><font face="arial" size="3" color="white"><b>Realtors</b></font></div></td>
</tr>
<tr>
...
<td><div align="center"><cfif #u_all.recordcount# is 1><cfoutput><a href="realtor_client_info.cfm?requestTimeout=6000&un=#un#&pw=#pw#&clientid=#u_all.id#&url1=#url1#"></cfoutput><cfelseif #u_all.recordcount# GT 1><cfoutput><a href="realtor_search.cfm?requestTimeout=6000&un=#un#&pw=#pw#&type=uall"></cfoutput></cfif><font face="arial" size="7" color="gray"><b><cfoutput>#u_all.recordcount#</cfoutput></b></font></a></td>
</tr>
</table>
</div>
<br><br>
...
<font face="arial" size="3">
	...
	<form action="Realtor_label_print4.cfm" method="post" target="_queue2">
		<cfoutput>
...
<form action="mainRealtor.cfm" method="post">
	<cfoutput>
		<input type="hidden" name="un" value="#un#">
		<input type="hidden" name="pw" value="#pw#">
...
<font face="arial" size="3">
	...
	<b><A href="printRealtorQueue.cfm?un=#un#&pw=#pw#" target="_blank">Print Letters</A></b><br>
	<b><A href="clearRealtorPrintQueue.cfm?un=#un#&pw=#pw#">Clear Letter Queue</A></b>
<Br><Br>
	...
	<b><A href="printRealtorQueue.cfm?un=#un#&pw=#pw#&type=followUp" target="_blank">Print Follow Up Letters</A></b><br>
	<b><A href="clearRealtorPrintQueue.cfm?un=#un#&pw=#pw#&type=followUp">Clear Follow Up Letter Queue</A></b><br>
<Br><Br>
