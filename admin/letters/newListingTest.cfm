...
<cfsavecontent variable="REQUEST.letter_body" >
	<cfoutput>
		<span class="fontsize12">
			...
			We see your home at #trim(getinfo.FROM_ADDRESS)#<cfif trim(getinfo.FROM_ADDRESS2) is not "">, #trim(getinfo.FROM_ADDRESS2)#</cfif>, has just been listed with #trim(getinfo.realty_company)#. Are you ready to
plan your move? We can help!
		</span>
	</cfoutput>
</cfsavecontent>
