...
#imageDiv {
	background-image: url("http://top12movingbiz.com/admin/letters/images/CarrierFlyer.jpg");
...
<div id="imageDiv">
	<!--- <div id="apDiv1"><span style="color:red; font-size:28px; font-weight:bold;"><cfoutput>#trim(REQUEST.letter_body)#</cfoutput></span></div> --->
</div>
    </body>
    </html>
