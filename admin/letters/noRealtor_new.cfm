...
<cfif directPrint is 1>
    ...
    <cfoutput>
        <table style="width:99%">
            <tr>
                <td>
                    <div class="nonLetter" style="font-family:arial">
            <div>
            ...
            <div style="padding-top:15px">
                ...
                After your appointment, your personal Certified Moving Consultant/Estimator will work to find you, out of a variety of carriers, a quality and affordable moving company
                that will fit your needs and budget. The in-home or virtual tour/estimate normally takes 30 minutes and your quote will be emailed to you the same day. 
            </div>

            <div style="margin-left:auto; margin-right:auto; width:100%; text-align:center; padding-top: 15px; font-size: 1.2em; font-weight: bold; line-height:29px">
...
<!--- <cffunction name="printNoRealtorLetter" returntype="string">
    <cfoutput>
        <div class="nonLetter" style="font-family:arial">
            <div>
                <div style="float:right; padding-top: 60px">
