    ...
    <cfoutput>
        <div class="letterBody" style="font-family:arial;">
            <div>
                ...
                <div >
                    <img src="http://www.top12movingbiz.com/admin/letters/images/logo_small.jpg" alt="" border="0" class="logoImg">
                </div>
            </div>
            ...
            <table border="0" cellspacing="0" cellpadding="0" width="100%" style="padding-top:25px">
                <tr>
                    ...
                    <td align="right" valign="top">
                        <div align="center">
                             <img src="http://www.top12movingbiz.com/admin/letters/3.jpg" class="otherImg" alt="" border="0"></div>
                    </td>
                </tr>
            </table>
