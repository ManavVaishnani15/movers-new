...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;We see that you are a loan officer or mortgage professional at #trim(getinfo.CompanyName)#.<br><br>

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Nationwide USA Movers is looking for professionals in your line of work to create a durable 
partnership and assist with referring clients that are selling or buying a property and need professional 
moving services.<br><br>
...
and insured moving companies nationwide to offer your clients that are getting loans to purchase a new home or are selling previous properties, a variety of moving services all in one stop. All moves are virtually surveyed for accuracy and 
ease.<br><br>
...
MC ##945837 USDOT## 3558324</span>
    ...
    where send_type=12 and cust_hook=#clientid#
    </cfquery>
...
<form action="mortgageEmailNew.cfm" method="post"><input type="hidden" name="clientid" value="<cfoutput>#clientid#</cfoutput>"><input type="hidden" name="sendmail" value="1"><cfoutput><input type="hidden" name="un" value="#un#"><input type="hidden" name="pw" value="#pw#"></cfoutput>
<div align="center">
