...
<head>
            <title><cfif parameterexists(clientid) is 'yes'>
                    <cfoutput>#getinfo.first_name# #getinfo.last_name# Close Letter</cfoutput>
                </cfif></title> 
            <style>
    body {
        height: 842px;
    ...
    .highlight {
        ...
        text-decoration: underline;
                                ...
                                <cfoutput>
                                    ...
                                    <br><br>
                                    &nbsp; <i>We see your home that is listed with <span style="font-weight:bold">#getinfo.realty_company#</span> is expected to close on
                                        #dateformat(getinfo.closing_date, "MM/DD/YYYY")#</i>.
                                    <div>
                                    &nbsp;&nbsp;&nbsp;
                                    Since your home is closing so fast <b>Top12Movers</b > would like to reach out and provide you up to 12 free move quotes where we guarantee to get you 
                                    up to <span style="font-weight:bold;font-style: italic;">70% discount</span> on your &nbsp;State-to-State move from the Top 12 Nationwide Moving Carriers.
                                    </div>
                                    <div>
                                        &nbsp;&nbsp;&nbsp;
                                ...
                                <div>
                                    &nbsp;&nbsp;&nbsp;
                                    Your free in home estimate is scheduled for <span class="redHighlight">#dateformat(getinfo.appointment_date, "MM/DD/YYYY")#</span> and a Certified Moving Consultant/Estimator will stop by to provide you up to 12 free moves quotes where you will find a moving company that will fit your needs and budget. The estimate normally takes 30 minutes (<i>just in and out no pressure selling</i>) and your quote will be emailed to you the same day.
                                </div>
                                    ...
                                    <div align="center" style="font-weight:bold;font-size:17px;line-height:20px; padding-top:0px">
                                           Your Free in Home Estimate for home selling at<br />
                                           <span style="text-decoration:underline">#getinfo.FROM_ADDRESS#<cfif getinfo.FROM_ADDRESS2 is not "">, #getinfo.FROM_ADDRESS2#</cfif></span> is scheduled for
                                            ...
                                            <br>
                                         <div class="redHighlightDate" style="padding: 10px 0">
                                                ...
                                                <div align="center" style="padding-top:0px">
                                                    <div align="center" style="padding-top:0px;line-height:20px">
                                                        <b>Please Call Our Appointment Line
                                                            ...
                                                            <br>
                                                            At
                                                            <span class="blueHighlight" style="font-size:20px">1-800-289-5329</span>
                                                            <br>
        ...
        <span style="margin-left:15px">(up to 40% savings)</span><br>
                                        ...
                                        <div style="font-weight:bold; text-decoration:underline; text-align:center; padding-top:10px;">
    ...
    .highlight {
        ...
        text-decoration: underline;
                                   ...
                                   <cfoutput>
                                    ...
                                    <div>
                                    &nbsp;&nbsp;&nbsp;
                                    Since your home is closing so fast <b>Top12Movers</b > would like to reach out and provide you up to 12 free move quotes where we guarantee to get you up to <span style="font-weight:bold;font-style: italic;">70% discount</span> on your &nbsp;State-to-State move from the Top 12 Nationwide Moving Carriers.
                                    </div>
                                    <div>
                                        &nbsp;&nbsp;&nbsp;
                                        Just mention your <span class="redHighlight">Personal Discount Code #getInfo.discountCode#</span> to get your discount, when calling to confirm your appointment.
...
values ('1','2','#clientid#','#datenow#')
                                        ...
                                        <cfelse>
                                            <cfif parameterexists(emailit) is 'yes'>
                                                <form action="close_letter.cfm" method="post">
                                ...
                                <cfif #getinfo.closing_date# is ''>
                                    ...
                                    <div align="center">
                                        <font face="arial" size="4" color="red">
                                            <b>
                                                THIS PAGE SHOULD NOT BE PRINTED - THERE IS NO CLOSING DATE SET YET
                                            </B>
                                        </FONT>
                                    </DIV>
                                    <br>
