...
<cfsavecontent variable="REQUEST.letter_body" >
	<cfoutput>
		<span class="fontsize12">
			...
			We see your home at #trim(getinfo.FROM_ADDRESS)#<cfif getinfo.FROM_ADDRESS2 is not "">, #trim(getinfo.FROM_ADDRESS2)#</cfif>, listed with #trim(getinfo.realty_company)#, is expecting to close around #dateformat(trim(getinfo.closing_date), "MM/DD/YYYY")#. Are you ready to plan your move? We can help!
		</span>
	</cfoutput>
</cfsavecontent>
