...
<table width="100%" border="0" cellspacing="0" cellpadding="10">
  <tr>
    ...
    <span class="fontsize12 fontbold">HAVE YOUR VIRTUAL ESTIMATE DONE BY</span><br><br>
    <span class="fontbold fontsize24 colorred"><cfoutput>#dateformat(getinfo.appointment_date, "MM/DD/YYYY")#</cfoutput></span>
    </td>
