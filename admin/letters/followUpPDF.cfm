...
<cfsavecontent variable="REQUEST.letter_body">
    <cfoutput>
        <div class="fontsize12" style="padding-left:15px; padding-right:15px; line-height:1.3em;">
            <br><br>
            ...
            <span class="fontbold colorred" style="text-decoration:underline;">#getinfo.discountCode#</span>.<br>
        </div>
