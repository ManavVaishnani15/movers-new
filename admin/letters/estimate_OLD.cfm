...
<cfif parameterexists(sendmail) is 'yes'>
    ...
    >
        ...
        <td valign="middle" width="100%"><div align="center"><font face="arial" size="3" color="black"><b>Affordable USA Movers </b></font><font size="1"><br></font><font face="arial" size="6" color="silver"><b>QUOTE</b></font></div></td>
        ...
        <cfoutput>
            ...
            <b>STREET ADDRESS</b>: #getinfo.from_address#<cfif #getinfo.from_address2# is not ''>#getinfo.from_address2#</cfif><br>
            ...
            <font face="arial" size="2">
                <b>
                    The following quotes represent the bottom line price for each of the listed carriers after discount. Please select your preferred carrier and contact your Moving Consultant 
                    to advise which company you have chosen. After you notify your Moving Consultant, you will immediately receive an email with a survey inventory and a detailed Customer Order 
                    For Service which will include the prices from the carrier you selected. 
                </b>
            </font>
            <br>
        </cfoutput>
        ...
        <tr>
        <td colspan="2"><div align="center"><font face="arial" size="2"><b>YOUR MOVE COST QUOTES</b></font></div></td>
        </tr>
        <tr>
        <td bgcolor="silver"><div align="center"><font face="arial" size="2">SERVICE PROVIDER (CARRIER)</font></div></td>
        <td bgcolor="silver"><div align="center"><font face="arial" size="2">QUOTE</font></div></td>
        </tr>
