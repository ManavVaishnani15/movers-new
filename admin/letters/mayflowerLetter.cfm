...
<cfif directPrint is 1>
    ...
    <span style="font-size:16px;margin-top:30px;">
      
   
We see that the home in which you currently reside at <i>#getinfo.FROM_ADDRESS#</i>, is listed with <b>#getinfo.realty_company#</b>. We can help you with your move!<br>
</span>
     ...
     <tr>
     <td><img src="http://www.top12movingbiz.com/admin/letters/images/VanBody2.png" alt="" border="0" width="100%"></td>
     </tr>
