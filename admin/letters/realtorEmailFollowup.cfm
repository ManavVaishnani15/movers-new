...
MC ##945837 USDOT## 3558324</span>
    ...
    where send_type=14 and cust_hook=#clientid#
    </cfquery>
    <cfif #check_initial.recordcount# is not 0><!--- was already sent once --->
        ...
        values ('15','2','#clientid#','#datenow#')
        </cfquery>
    <cfelse>
        <cfquery name="set_initial" datasource="aaalh3x_onestep">
        insert into realtor_LETTER_SENDS
        (send_type,sent,cust_hook,sent_date)
        values ('14','2','#clientid#','#datenow#')
        </cfquery>
    </cfif>
...
<form action="realtorEmailFollowup.cfm" method="post"><input type="hidden" name="clientid" value="<cfoutput>#clientid#</cfoutput>"><input type="hidden" name="sendmail" value="1"><cfoutput><input type="hidden" name="un" value="#un#"><input type="hidden" name="pw" value="#pw#"></cfoutput>
<div align="center">
