...
<cfif parameterexists(sendmail) is 'yes'>
    ...
    <cfsavecontent variable="REQUEST.letter_body">
        <cfoutput>
            <div class="fontsize14" style="padding-left:15px; padding-right:15px; line-height:1.3em;">
                ...
                is pending and will be closing soon, we will be offering you huge moving discounts.<br><br>
    ...
    <cfmail
        ...
        SUBJECT="Closing Soon - Moving Discount Available"
        TYPE="HTML">
        #emailContent#
    </cfmail>
...
<div class="page-container">
    <cfif parameterexists(emailit) is 'yes'>
        <form action="closingLetter.cfm" method="post">
