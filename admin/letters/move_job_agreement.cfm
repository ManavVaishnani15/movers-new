...
<style>
    ...
    .extra-box {
        border: 3px solid #000;
        padding: 12px 18px;
        height: 550px; /* adjust based on space needed */
        box-sizing: border-box;
        font-weight: bold;
        font-size: 16px;
    }
...
<cfoutput>
    <div style="padding:0 30px;">
        ...
        <!-- Title -->
        <p style="font-size:18px; font-weight:bold; margin:140px 0 0 0; text-align:center;">
            Move Job Acceptance Agreement
        </p>

        <!-- Subtitle (UNDERLINES) -->
        <p style="font-size:14px; font-style:italic; font-weight:bold; margin:0 0 4px 0; text-align:center;">
            <u>Read carefully and Initial all pages</u>
        </p>
        <p style="font-size:14px; font-style:italic; font-weight:bold; margin:0 0 4px 0; text-align:center;">
            <u>Sign and return this agreement as soon as possible</u>
        </p>
        <p style="font-size:14px; font-style:italic; font-weight:bold; margin:0 0 10px 0; text-align:center;">
            <u>or max within the next 12h to accept the move</u>
        </p>

        <div class="form-line" style="margin-top:30px;">
            <span class="label">CUSTOMER NAME:</span>
            <span class="line" style="width:64%; font-weight:normal;">#getMoveJobAgreement.customer_name#</span>
        </div>

        <div class="form-line phone-email" style="margin-top:20px;">
            <span class="label">CUSTOMER PHONE NUMBER:</span>
            <span class="line" style="width:20%; font-weight:normal;">#getMoveJobAgreement.customer_phone#</span>

            <span class="label" style="margin-left:10px;">EMAIL:</span>
            <span class="line" style="width:37%; font-weight:normal; white-space:nowrap; overflow:hidden; text-overflow:ellipsis;">#getMoveJobAgreement.customer_email#</span>
        </div>

        <div class="form-line" style="margin-top:20px;">
            <span class="label">MOVE FROM:</span>
            <span class="line" style="width:70%; font-weight:normal;">#getMoveJobAgreement.move_from#</span>
        </div>

        <div class="form-line" style="margin-top:20px;">
            <span class="label">MOVE TO:</span>
            <span class="line" style="width:73%; font-weight:normal;">#getMoveJobAgreement.move_to#</span>
        </div>

        <div class="form-line" style="margin-top:20px;">
            <span class="label">PACKING/LOADING DATE:</span>
            <span class="line" style="width:57%; font-weight:normal;">#DateFormat(getMoveJobAgreement.packing_loading_date, "mm/dd/yyyy")#</span>
        </div>

        <div class="form-line" style="margin-top:20px;">
            <span class="label">DELIVERY DATE:</span>
            <span class="line" style="width:66%; font-weight:normal;">#DateFormat(getMoveJobAgreement.delivery_date, "mm/dd/yyyy")#</span>
        </div>
        ...
        <div class="form-line" style="margin-top:30px;">
            ...
            <span class="line" style="width:80%; font-weight:normal;">#getMoveJobAgreement.move_size#</span>
        </div>
        ...
        <div style="width:100%; margin-top:55px;">
            <table style="width:100%; border-collapse:collapse;">
                <tr>
                    ...
                    <!-- BROKER INITIALS -->
                    <td style="width:80%; text-align:right; font-size:13px; padding-right:20px;">
    ...
    <div style="padding:0 30px;">
        ...
        <div class="form-line" style="margin:140px 0 0 0;">
            <span class="label">PACKING: </span>
            <span class="line" style="width:80%; font-weight:normal;">#getMoveJobAgreement.packing#</span>
        </div>
    ...
    <div style="padding:0 30px;">
        <div class="extra-box" style="margin-top:140px;">
    ...
    <div style="padding:0 30px;">
        <div style="border:3px solid ##000; padding:8px; font-weight:bold; margin-top:140px; font-size:14px;">
        ...
        <cfelse>
            <cfset repName = "______________________________">
        </cfif>
        ...
        <cfelse>
            <cfset repRole = "______________________________">
        </cfif>
        
        <!-- PARAGRAPH 1 -->
        <p style="font-size:14px; line-height:1.4; text-align:justify; font-weight:bold;">
            I,<span style="display:inline-block; border-bottom:2px solid ##000; min-width:200px; padding:0 5px; font-weight:normal;">
            #repName#</span>, representative of (<strong>#carrier.CompanyName#</strong>) accept 
        ...
        <p style="font-size:14px; margin-top:30px; font-weight:bold;">
        ...
        <p style="font-size:14px; line-height:1.4; text-align:justify; font-weight:bold;">
            I,<span style="display:inline-block; border-bottom:2px solid ##000; min-width:200px; padding:0 5px; font-weight:normal;">
            #repName#</span>, authorized representative of 
        ...
        <p style="font-size:14px; line-height:1.4; text-align:justify; font-weight:bold;">
            I, <span style="display:inline-block; border-bottom:2px solid ##000; min-width:200px; padding:0 5px; font-weight:normal;">
            #repName#</span>, representative of 
    ...
    <div style="padding:0 30px;">
        <p style="font-size:14px; line-height:1.4; text-align:justify; font-weight:bold; margin-top:200px;">
            I,<span style="display:inline-block; border-bottom:2px solid ##000; min-width:200px; padding:0 5px; font-weight:normal;">
            #repName#</span>,  authorized representative of
        ...
        <p style="font-size:14px; line-height:3; text-align:justify; font-weight:bold; ">
            I,<span style="display:inline-block; border-bottom:2px solid ##000; min-width:200px; padding:0 5px; line-height:1.4; vertical-align:baseline; font-weight:normal;">
            #repName#</span>,  authorized representative of 
            (<strong>#carrier.CompanyName#</strong>)
    ...
    <div style="padding:0 30px;">
        <p style="font-size:14px; line-height:3; text-align:justify; font-weight:bold; margin-top:170px;">
            I,<span style="display:inline-block; border-bottom:2px solid ##000; min-width:200px; padding:0 5px; line-height:1.4; vertical-align:baseline; font-weight:normal;">
            #repName#</span>,  authorized representative of 
            (<strong>#carrier.CompanyName#</strong>)
        ...
        <div class="extra-box" style="margin-top:10px; height:450px;">
    ...
    <div style="padding:0 50px;">
        <p style="font-size:14px; line-height:3; text-align:justify; font-weight:bold; margin-top:200px;">
            I, <span style="display:inline-block; border-bottom:2px solid ##000; min-width:200px; padding:0 5px; line-height:1.4; vertical-align:baseline; font-weight:normal;">
            #repName#</span>, in the role of  <span style="display:inline-block; border-bottom:2px solid ##000; min-width:200px; padding:0 5px; line-height:1.4; vertical-align:baseline; font-weight:normal;">
            #repRole#</span>,
        ...
        <div style="width:100%; margin-top:470px;">
            <table style="width:100%; border-collapse:collapse;">
                <tr>
                    <!-- PAGE NUMBER -->
                    <td style="width:20%; text-align:left; font-size:13px;">
    ...
    <div style="padding:0 30px;">
        <p style="font-size:14px; margin-top:140px;">
    ...
    <div style="padding:0 30px;">
        ...
        <div style="width:100%; margin-top:600px;">
            <table style="width:100%; border-collapse:collapse;">
                <tr>
                    <!-- PAGE NUMBER -->
                    <td style="width:20%; text-align:left; font-size:13px;">
