...
<cffunction name="printHanger2" returntype="string">
    <cfoutput>
    <div class="hangerMain">
        ...
        <div style="padding-top:15px">
            <span class="redHighlight">WE HAVE AN APPOINTMENT!!!</span>
        </div>
        ...
        <div>
            TO PROVIDE YOU A <span style="text-decoration:underline">FREE</span> MOVE QUOTE
        </div>
