            ...
            <td class="hangerDiv">
                ...
                <div class="hangerMain">
                    ...
                    <div style="padding-top:10px">
                        <span class="redHighlight" style="text-decoration: underline;">CONGRATULATIONS!!!</span>
                    </div>
                    ...
                    <div style="width:80%; margin-left:auto; margin-right: auto; padding-top:15px;">
                        ...
                        <div style="font-size:0.9em; padding-top:3px">
                            OR CURRENT OCCUPANT
                        </div>
                    </div>
                    ...
                    <div style="line-height:22px">
                        WE SEE YOUR HOME JUST RECEIVED AN OFFER ON<br />
                        <span class="redHighlight" style="font-size: 1.5em">#dateformat(getinfo.contract_date, "MM/DD/YYYY")#</span>
                        <br />
                        AND WE WOULD LIKE TO PROVIDE YOU A <span style="text-decoration:underline">FREE</span><br />
                        MOVE QUOTE
                    </div>

                    <div style="font-size:0.85em;font-style: italic; font-weight: normal">
                         (Takes 30min - Quote emailed to you same day)
                    </div>
                    
                    <div style="padding-top:10px; line-height:20px">
                        PLEASE CALL US IMMEDIATELY<br />
                       
                        TO SET UP AN APPOINTMENT WITH A<br />
                        CERTIFIED MOVING CONSULTANT<br />
                        AND MENTION YOUR<br />
                    ...
                    <div style="padding-bottom:5px; padding-top:5px" class="blueHighlight">
                       PHONE 
                    ...
                    <div class="blueHighlight" style="font-size: 1.1em; ">
...
<cffunction name="printApptUrgent" returntype="string">
    ...
    <div class="hangerMain">
        ...
        <div style="line-height:22px">
            WE SEE YOUR HOME JUST RECEIVED <br />AN OFFER ON <br />
            <span class="redHighlight" style="font-size: 1.4em">#dateformat(getinfo.contract_date, "MM/DD/YYYY")#</span>
            <br />
            AND WE WOULD LIKE TO PROVIDE YOU A <br /><span style="text-decoration:underline">FREE</span> MOVE QUOTE 
        </div>
        ...
        <div style="text-align: left">
            <div style="padding-top:7px;font-size:0.9em">
                **  Up to a 70% discount off the Tariff Rates on out of<br>
                <span style="padding-left:13px">State moves </span>
            </div>
        ...
        <div style="padding-bottom:10px; padding-top:10px" class="blueHighlight">
           PHONE 
           <cfif getInfo.door_hanger_state is "DC">
                (202)-729-8277
            <cfelseif getInfo.door_hanger_state is "MD">
        ...
        <div style="padding-top:5px;font-size:0.9em;" class="blueHighlight">
            www.affordable<span style="color: red">usa</span>movers.com
        </div>
    </div>
    </cfoutput>
