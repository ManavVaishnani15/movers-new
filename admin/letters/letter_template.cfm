...
<cfoutput>
	<table class="width100p" align="center" border="0" cellpadding="0" cellspacing="0"<!--- style="margin-top:-10px"--->>
			<tr>
...
vanlinequotes.com will be at your side 7 days a week managing and monitoring your move from start to finish.
			...
			<tr>
				...
				<td class="width40p">
					<img src="http://www.top12movingbiz.com/admin/letters/images/postcard THUMBNAIL NEW.png" alt="" border="0" class="width78p height91p" style="margin-left:23px;padding-top:0px;"/>
				</td>
				<td class="width20p">
			...
			<tr>
				<td colspan="3" class="fontbold fontsize26 colornavy text-align-center"border="1" height="30px;" valign="bottom">
					<p class="lock">LOCK-IN UP TO 40% IN MOVE SAVINGS NOW!!</p> 
				</td>
			</tr>
		</table>
			...
			<tr>
				...
				<td class="width40p line-height-letter text-align-center">
					<span class="fontbold fontsize20 colornavy" style="margin-top:20px;">
				...
				<td class="width40p line-height-letter">
					<table  class="width100p" align="center" border="0">
						<tr>
							...
							<td>
								<span class="fontbold fontsize16 colorred" style="margin-left:-3px;position:absolute;margin-top:-32px">
									MOVE DISCOUNT CODE<br />
									<span style="margin-left:51px;position:absolute;margin-top:27px">#getInfo.discountCode#</span><br />
								</span>
								
								<span class="fontbold fontsize10 colorred" style="margin-left:33px;position:absolute;margin-top:19px">
			...
			<table  class="width100p" align="center" border="0">
			<tr>
				<td class="text-align-center" align="left" style="width:17%;vertical-align:bottom;">
