...
<cfif parameterexists(sendmail) is 'yes'>
    ...
    <cfsavecontent variable="REQUEST.letter_body">
        <cfoutput>
            <div class="fontsize14" style="padding-left:15px; padding-right:15px; line-height:1.3em;">
                ...
                was recently listed, we will be offering you huge moving discounts.<br><br>
    ...
    <cfmail
        ...
        SUBJECT="New Listing - Moving Discount Available"
        TYPE="HTML">
        #emailContent#
    </cfmail>
...
<div class="page-container">
    <cfif parameterexists(emailit) is 'yes'>
        <form action="newListing.cfm" method="post">
