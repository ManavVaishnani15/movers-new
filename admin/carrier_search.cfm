...
<CFIF IsDefined("form.clearSelected")>
    ...
    <cfloop list="#form.theCustomerID#" delimiters="," index="custID">
      <cfquery name="qInsertLabel" datasource="aaalh3x_onestep">
        INSERT INTO carrier_letter_sends(send_type,cust_hook,sent,active,user_hook,followup_date)
...
<cfparam name="type" default="uall">
...
<cfelseif #type# is 'uall'>
<font face="arial" size="3"><b>Carriers - All</b></font><br><Br>
</cfif>
<cfif #searchit.recordcount# is 0>
 ...
 <cfoutput><FORM ACTION="carrier_Search.cfm?requestTimeout=6000&un=#un#&pw=#pw#&type=uall" METHOD="Post"></cfoutput>
 <table border="1" cellspacing="0" cellpadding="3">
 <tr bgcolor="navy">
 <td><input name="selectAllRecords" id="selectAllRecords" type="checkbox" value="" onClick="toggle(this);"></td>
 <td><font face="arial" size="2" color="white"><b>Carrier</b></font></td>
 <td><font face="arial" size="2" color="white"><b>Contact</b></font></td>
...
<!--- <td><div align="center"><font face="arial" size="2" color="white"><b>Status</b></font></div></td>--->
 <td><div align="center"><font face="arial" size="2" color="white"><b>City</b></font></div></td>
...
<!--- <cfif #type# is 'uweek' or #type# is 'umonth' or #type# is 'uall'><td><div align="center"><font face="arial" size="2" color="white"><b>No Realtor Letter</b></font></div></td></cfif>--->
 </tr>
...
<!---  <cfquery name="sends" datasource="aaalh3x_onestep">
  ...
  where cust_hook=#searchit.id# and (send_type=998 or send_type=6)
        and sent=1
...
<cfset url1 ='search'>
 ...
 <td><a href="carrier_client_info.cfm?un=#un#&pw=#pw#&clientid=#searchit.id#&url1=#url1#&type=#type#" target="_#searchit.id#"><font face="arial" size="2" color="blue"><b>#searchit.Companyname#</b></font></a></td>
 <td><font face="arial" size="2" color="blue"><b>#searchit.replastname#, #searchit.repfirstname#</b></font></td>
...
<!--- <td><div align="center"><font face="arial" size="2">#searchit.city#, #searchit.state#</font></div></td>--->
 <cfif #type# is 'uweek' or #type# is 'umonth' or #type# is 'uall'><td <cfif #get_letters.recordcount# is not 0>bgcolor="green"</cfif>><div align="center">
 	
 	<cfif get_letters.recordcount neq 0>
 			<font face="arial" size="2" color="white"><b><cfif #get_letters.sent# is 1>Mailed<cfelseif #get_letters.sent# is 2>Emailed</cfif> #dateformat(get_letters.sent_date, "MM/DD/YYYY")#</b></font>
 	<cfelse><font face="arial" size="2">Not Sent Yet</font></cfif></div></td>
 	
 </cfif>

<!---<cfif #type# is 'uweek' or #type# is 'umonth' or #type# is 'uall'>
  <td <cfif #noRealtorSent.recordcount# is not 0>bgcolor="green"</cfif>>
    <div align="center">
      <cfif #noRealtorSent.recordcount# is not 0>
        <font face="arial" size="2" color="white">
          <b><cfif #noRealtorSent.sent# is 1>Mailed<cfelseif #noRealtorSent.sent# is 2>Emailed</cfif> 
          #dateformat(noRealtorSent.sent_date, "MM/DD/YYYY")#</b>
        </font>
      <cfelse>
        <font face="arial" size="2">Not Sent Yet</font>
      </cfif>
    </div>
  </td>
</cfif>--->
...
<br>
<div align="center">
<input name="clearSelected" type="submit" value="CLEAR SELECTED CARRIERS">
</div>
</FORM>
