...
<cfif #searchit.recordcount# is 0>
 ...
 <cfoutput><FORM ACTION="Search.cfm?requestTimeout=6000&un=#un#&pw=#pw#&type=uall" METHOD="Post"></cfoutput>
...
<cfset url1 ='search'>
 ...
 <td><a href="client_info.cfm?un=#un#&pw=#pw#&clientid=#searchit.id#&url1=#url1#&type=#type#" target="_#searchit.id#"><font face="arial" size="2" color="blue"><b>#searchit.last_name#, #searchit.first_name#</b></font></a></td>
...
<br>
<div align="center">
<input name="clearSelected" type="submit" value="CLEAR SELECTED CUSTOMERS">
</div>
</FORM>
