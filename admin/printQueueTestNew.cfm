    ...
    <cfoutput query="printQueue">
        ...
        <cfelseif printQueue.printType is "followUp">
            ...
            <cfquery  datasource="aaalh3x_onestep">
                update printQueue
                set printed = 1
                where id = <cfqueryparam cfsqltype="cf_sql_bigint" value="#printQueue.id#">
            </cfquery>
            <cfquery  datasource="aaalh3x_onestep">
            ...
            <cfdocumentsection>
            	<cfif structKeyExists(url,'version') and trim(url.version) eq 'old'>
            		<cfinclude template="letters/followUpOld.cfm" />
        		<cfelse>
            		<cfinclude template="letters/followUpTestNew.cfm" />
            	</cfif>
            </cfdocumentsection>
