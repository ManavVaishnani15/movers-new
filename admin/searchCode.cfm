...
<br>
<b>Search Again</b><br>
<form action="searchCode.cfm?requestTimeout=6000" method="post">
<cfoutput>
<input type="hidden" name="un" value="#un#"><input type="hidden" name="pw" value="#pw#">
</cfoutput>
