...
<cfif parameterexists(useid) is 'yes'>
<cfquery name="a" datasource="aaalh3x_onestep">
...
<tr><td><img src="labelbox.jpg" width="200" height="81" border="0" alt=""></td>
<td><img src="labelbox.jpg" width="200" height="81" border="0" alt=""></td><cfset COLUMNNBR = 3></cfif>
<cfloop query="currentcount" startrow="1" endrow="#THENBR#"><cfquery name="g" datasource="aaalh3x_onestep">select * from carrier_records
where id=#currentcount.cust_hook#</cfquery>

<cfoutput><cfif #COLUMNNBR# is 1 and #ROWNBR# LT 11><tr><td style="font-size:12px;">

<cfif #g.repfirstname# is not ''>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>ATTN #g.repfirstname# #g.replastname#<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;or Company Representative</b><cfelse></cfif><br/>
<cfif #g.CompanyName# is not ''>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#g.CompanyName#<br/></cfif>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#g.Mailingaddress#<br />
<cfif #g.Mailingaddress2# is not ''>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#g.Mailingaddress2#<br/></cfif>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#g.Mailingcity# #g.Mailingstate# #g.Mailingzip#<br/><br/>
</td>
<cfset COLUMNNBR = 2><cfelseif #COLUMNNBR# is 2><td>
<cfif #g.repfirstname# is not ''>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>ATTN #g.repfirstname# #g.replastname#<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;or Company Representative</b><cfelse></cfif><br/>
<cfif #g.CompanyName# is not ''>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#g.CompanyName#<br/></cfif>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#g.Mailingaddress#<br />
<cfif #g.Mailingaddress2# is not ''>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#g.Mailingaddress2#<br/></cfif>
...
<cfelseif #COLUMNNBR# is 3><td>
<cfif #g.repfirstname# is not ''>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>ATTN #g.repfirstname# #g.replastname#</b><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;or Company Representative<cfelse></cfif><br/>
<cfif #g.CompanyName# is not ''>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#g.CompanyName#<br/></cfif>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#g.Mailingaddress#<br />
<cfif #g.Mailingaddress2# is not ''>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#g.Mailingaddress2#<br/></cfif>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;#g.Mailingcity#  #g.Mailingstate# #g.Mailingzip#<br/><br/>
